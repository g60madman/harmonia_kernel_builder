...
export WORKDIR=/media/android/harmonia_kernel_builder

#The kernel source directory
export KERNELDIR=/media/android/harmonia_kernel_builder/kernel
...
#	cp ../ramdisk/ramdisk.img ramdisk.img
	...
	zip -r $KERNELZIP_VERSION *
        cp $KERNELDIR/zImage ../releasetools/kernel
	cd ..
